...
if __name__ == '__main__':
    ...
    train_dataset = RSSCN7Dataset(root_dir="./RSSCN7/train",train=True,transform=transform_train)
    test_dataset = RSSCN7Dataset(root_dir="./RSSCN7/test",train=False,transform=transform_test)
    ...
    for i in range(len(total_test_accuracy_list)):
        with open('mnist_3k_nopre_mish_Skipnet18_0_70_128_0.01.txt', 'a') as f:
    ...
    torch.save(test_net.state_dict(),"mnist_3k_nopre_mish_Skipnet18_0_70_128_0.01.pkl")